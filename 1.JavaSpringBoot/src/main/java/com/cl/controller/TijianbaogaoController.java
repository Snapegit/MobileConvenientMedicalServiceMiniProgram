...
public class TijianbaogaoController {
    ...
    public R page(@RequestParam Map<String, Object> params,TijianbaogaoEntity tijianbaogao,
		...
		if(tableName.equals("yonghu")) {
			tijianbaogao.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R info(@PathVariable("id") Long id){
		...
		tijianbaogao = tijianbaogaoService.selectView(new EntityWrapper<TijianbaogaoEntity>().eq("id", id));
