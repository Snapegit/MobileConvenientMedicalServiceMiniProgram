...
public class TijianyuyueController {
    ...
    public R page(@RequestParam Map<String, Object> params,TijianyuyueEntity tijianyuyue,
		...
		if(tableName.equals("yonghu")) {
			tijianyuyue.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yisheng")) {
			tijianyuyue.setYishengzhanghao((String)request.getSession().getAttribute("username"));
		}
