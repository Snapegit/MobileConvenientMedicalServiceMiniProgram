				...
				<el-row>
					<el-col :span="24">
						<el-form-item label="疫苗编号" prop="yimiaobianhao">
							<el-input class="list_inp" v-model="form.yimiaobianhao" :readonly="true" placeholder="疫苗编号" />
						</el-form-item>
					</el-col>
					<el-col :span="24">
					...
					<el-col :span="24">
						<el-form-item label="疫苗类型" prop="yimiaoleixing">
							<el-select
								class="list_sel"
								:disabled="!isAdd||disabledForm.yimiaoleixing?true:false"
								v-model="form.yimiaoleixing" 
								placeholder="请选择疫苗类型"
								>
								<el-option v-for="(item,index) in yimiaoleixingLists" :label="item"
									:value="item"
									>
								</el-option>
							</el-select>
					...
					<el-col :span="24">
						<el-form-item label="接种流程" prop="jiezhongliucheng">
							<el-input v-model="form.jiezhongliucheng" placeholder="接种流程" type="textarea"
							:readonly="!isAdd||disabledForm.jiezhongliucheng?true:false"
							/>
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="副作用" prop="fuzuoyong">
							<el-input v-model="form.fuzuoyong" placeholder="副作用" type="textarea"
							:readonly="!isAdd||disabledForm.fuzuoyong?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='jiezhongliucheng'){
					form.value.jiezhongliucheng = row[x];
					disabledForm.value.jiezhongliucheng = true;
					continue;
				}
				if(x=='fuzuoyong'){
					form.value.fuzuoyong = row[x];
					disabledForm.value.fuzuoyong = true;
					continue;
				}
			}
			if(row){
		...
		yimiaoleixingLists.value = "2阶,4阶,9阶".split(',')
	}
	//初始化
	//声明父级调用
	defineExpose({
