				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="内容" prop="neirong">
							<el-input v-model="form.neirong" placeholder="内容" type="textarea"
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.xiangqing = res.data.data.xiangqing?(res.data.data.xiangqing.replace(reg,'../../../cl1121704/file')):'';
