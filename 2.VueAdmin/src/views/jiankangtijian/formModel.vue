				...
				<el-row>
					...
					<el-col :span="24">
						<el-form-item label="体检分类" prop="tijianfenlei">
							<el-select
								class="list_sel"
								:disabled="!isAdd||disabledForm.tijianfenlei?true:false"
								v-model="form.tijianfenlei" 
								placeholder="请选择体检分类"
								>
								<el-option v-for="(item,index) in tijianfenleiLists" :label="item"
									:value="item"
									>
								</el-option>
							</el-select>
					...
					<el-col :span="24">
						<el-form-item label="体检图片" prop="tijiantupian">
							<uploads
								:disabled="!isAdd||disabledForm.tijiantupian?true:false"
								action="file/upload" 
								tip="请上传体检图片" 
								:limit="3" 
								style="width: 100%;text-align: left;"
								:fileUrls="form.tijiantupian?form.tijiantupian:''" 
								@change="tijiantupianUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="体检地点" prop="tijiandidian">
							<el-input class="list_inp" v-model="form.tijiandidian" placeholder="体检地点"
								 type="text" 								:readonly="!isAdd||disabledForm.tijiandidian?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="体检费用" prop="tijianfeiyong">
							<el-input class="list_inp" v-model.number="form.tijianfeiyong" placeholder="体检费用"
								 type="number" 								:readonly="!isAdd||disabledForm.tijianfeiyong?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="体检流程" prop="tijianliucheng">
							<editor :value="form.tijianliucheng" placeholder="请输入体检流程" :readonly="!isAdd||disabledForm.tijianliucheng?true:false"
								class="list_editor" @change="(e)=>editorChange(e,'tijianliucheng')"></editor>
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.tijianliucheng = res.data.data.tijianliucheng?(res.data.data.tijianliucheng.replace(reg,'../../../cl1121704/file')):'';
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		context?.$http({
			url: `option/tijianfenlei/tijianfenlei`,
			method: 'get'
		}).then(res=>{
			tijianfenleiLists.value = res.data.data
		})
	}
	//初始化
	//声明父级调用
