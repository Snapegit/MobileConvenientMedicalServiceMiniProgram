		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					<el-col :span="24">
						<el-form-item label="体检项目" prop="tijianxiangmu">
							<el-input class="list_inp" v-model="form.tijianxiangmu" placeholder="体检项目"
								 type="text" 								:readonly="!isAdd||disabledForm.tijianxiangmu?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="体检分类" prop="tijianfenlei">
							<el-input class="list_inp" v-model="form.tijianfenlei" placeholder="体检分类"
								 type="text" 								:readonly="!isAdd||disabledForm.tijianfenlei?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="体检报告" prop="tijianbaogao">
							<uploads
								:disabled="!isAdd||disabledForm.tijianbaogao?true:false"
								type="file"
								action="file/upload" 
								tip="请上传体检报告" 
								:limit="1" 
								style="width: 100%;text-align: left;"
								:fileUrls="form.tijianbaogao?form.tijianbaogao:''" 
								@change="tijianbaogaoUploadSuccess">
							</uploads>
						</el-form-item>
					</el-col>
					<el-col :span="24">
					...
					<el-col :span="24">
						<el-form-item label="体检说明" prop="tijianshuoming">
							<el-input class="list_inp" v-model="form.tijianshuoming" placeholder="体检说明"
								 type="text" 								:readonly="!isAdd||disabledForm.tijianshuoming?true:false" />
						</el-form-item>
					</el-col>
					...
					<el-col :span="24">
						<el-form-item label="体检结果" prop="tijianjieguo">
							<el-input v-model="form.tijianjieguo" placeholder="体检结果" type="textarea"
							:readonly="!isAdd||disabledForm.tijianjieguo?true:false"
							/>
						</el-form-item>
					</el-col>
				</el-row>
...
<script setup>
	...
	const type = ref('')
	//体检报告上传回调
	const tijianbaogaoUploadSuccess=(e)=>{
		form.value.tijianbaogao = e
	}
	//methods
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='tijianfenlei'){
					form.value.tijianfenlei = row[x];
					disabledForm.value.tijianfenlei = true;
					continue;
				}
				if(x=='tijianbaogao'){
					form.value.tijianbaogao = row[x];
					disabledForm.value.tijianbaogao = true;
					continue;
				}
				if(x=='baogaoshijian'){
				...
				if(x=='tijianshuoming'){
					form.value.tijianshuoming = row[x];
					disabledForm.value.tijianshuoming = true;
					continue;
				}
				if(x=='yonghuzhanghao'){
				...
				if(x=='tijianjieguo'){
					form.value.tijianjieguo = row[x];
					disabledForm.value.tijianjieguo = true;
					continue;
				}
	...
	//提交
	const save=()=>{
		if(form.value.tijianbaogao!=null) {
			form.value.tijianbaogao = form.value.tijianbaogao.replace(new RegExp(context?.$config.url,"g"),"");
		}
