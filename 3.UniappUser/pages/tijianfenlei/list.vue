...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
	<view class="content">
		<view :style='{"width":"100%","padding":"0 0 0 0","position":"relative","background":"#ffffff","height":"100%"}'>
			<view :style='{"minHeight":"100rpx","width":"100%","position":"relative","alignItems":"center","justifyContent":"space-between","display":"flex"}'>
				<view :style='{"backgroundColor":"#f5f5f5","margin":"0 30rpx 0 30rpx","color":"#333333","alignItems":"center","borderRadius":"40rpx","flex":"1","display":"flex","lineHeight":"64rpx","fontSize":"24rpx","height":"64rpx"}'>
					...
					<input v-model="searchForm.tijianfenlei" type="text" placeholder="体检分类" :style='{"background":"transparent","height":"100%"}'></input>
				</view>
			...
			<view v-if="lists.length" class="list-box4" :style='{"width":"calc(100% - 220rpx)","padding":"24rpx 24rpx 24rpx 24rpx","margin":"0px 0 0 0","flex":"1","height":"auto"}'>
				...
				<view v-if="list.length>0" @tap="onDetailTap(list[0])" class="list-item" :style='{"width":"100%","padding":"0 0 0 0","margin":"0 0 20rpx 0","position":"relative","height":"auto"}'>
				  <view :style='{"width":"100%","padding":"40rpx 20rpx 40rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
				  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('tijianfenlei','修改')) || (!userid && isAuthFront('tijianfenlei','修改'))" @click.stop="onUpdateTap(list[0].id)">
				  	...
				  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('tijianfenlei','删除')) || (!userid && isAuthFront('tijianfenlei','删除'))" @click.stop="onDeleteTap(list[0].id)">
				...
				<view v-if="list.length>1" class="list-item-body" :style='{"width":"100%","padding":"0 0 0 0","margin":"0 0 20rpx 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
					<view v-if="list.length>1" @tap="onDetailTap(list[1])" :style='{"width":"48%","padding":"0 0 0 0","margin":"0 0 0 0","position":"relative","height":"auto"}'>
					  ...
					  <view :style='{"width":"100%","padding":"40rpx 20rpx 40rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
					  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('tijianfenlei','修改')) || (!userid && isAuthFront('tijianfenlei','修改'))" @click.stop="onUpdateTap(list[1].id)">
					  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}' class="iconfont icon-xiugai1"></text>
					  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}'>修改</text>
					  	</view>
					  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('tijianfenlei','删除')) || (!userid && isAuthFront('tijianfenlei','删除'))" @click.stop="onDeleteTap(list[1].id)">
					  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}' class="iconfont icon-shanchu1"></text>
					  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}'>删除</text>
					  	</view>
					  </view>
					...
					<view v-if="list.length>2" @tap="onDetailTap(list[2])" :style='{"width":"48%","padding":"0 0 0 0","margin":"0 0 0 0","position":"relative","height":"auto"}'>
					  ...
					  <view :style='{"width":"100%","padding":"40rpx 20rpx 40rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
					  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('tijianfenlei','修改')) || (!userid && isAuthFront('tijianfenlei','修改'))" @click.stop="onUpdateTap(list[2].id)">
					  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}' class="iconfont icon-xiugai1"></text>
					  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}'>修改</text>
					  	</view>
					  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('tijianfenlei','删除')) || (!userid && isAuthFront('tijianfenlei','删除'))" @click.stop="onDeleteTap(list[2].id)">
					  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}' class="iconfont icon-shanchu1"></text>
					  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}'>删除</text>
					  	</view>
					  </view>
				...
				<view v-if="list.length>3" @tap="onDetailTap(list[3])" class="list-item" :style='{"width":"100%","padding":"0 0 0 0","margin":"0 0 20rpx 0","position":"relative","height":"auto"}'>
				  <view :style='{"width":"100%","padding":"40rpx 20rpx 40rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
				  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('tijianfenlei','修改')) || (!userid && isAuthFront('tijianfenlei','修改'))" @click.stop="onUpdateTap(list[3].id)">
				  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}' class="iconfont icon-xiugai1"></text>
				  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}'>修改</text>
				  	</view>
				  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('tijianfenlei','删除')) || (!userid && isAuthFront('tijianfenlei','删除'))" @click.stop="onDeleteTap(list[3].id)">
				  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}' class="iconfont icon-shanchu1"></text>
				  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}'>删除</text>
				  	</view>
				  </view>
				...
				<view v-if="list.length>4" class="list-item-body" :style='{"width":"100%","padding":"0 0 0 0","margin":"0 0 0 0","justifyContent":"space-between","display":"flex","height":"auto"}'>
					<view v-if="list.length>4" @tap="onDetailTap(list[4])" :style='{"width":"48%","padding":"0 0 0 0","margin":"0 0 0 0","position":"relative","height":"auto"}'>
					  ...
					  <view :style='{"width":"100%","padding":"40rpx 20rpx 40rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
					  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('tijianfenlei','修改')) || (!userid && isAuthFront('tijianfenlei','修改'))" @click.stop="onUpdateTap(list[4].id)">
					  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}' class="iconfont icon-xiugai1"></text>
					  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}'>修改</text>
					  	</view>
					  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('tijianfenlei','删除')) || (!userid && isAuthFront('tijianfenlei','删除'))" @click.stop="onDeleteTap(list[4].id)">
					  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}' class="iconfont icon-shanchu1"></text>
					  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}'>删除</text>
					  	</view>
					  </view>
					...
					<view v-if="list.length>5" @tap="onDetailTap(list[5])" :style='{"width":"48%","padding":"0 0 0 0","margin":"0 0 0 0","position":"relative","height":"auto"}'>
					  ...
					  <view :style='{"width":"100%","padding":"40rpx 20rpx 40rpx 20rpx","justifyContent":"space-between","display":"flex","height":"auto"}'>
					  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('tijianfenlei','修改')) || (!userid && isAuthFront('tijianfenlei','修改'))" @click.stop="onUpdateTap(list[5].id)">
					  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}' class="iconfont icon-xiugai1"></text>
					  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#069888","display":"inline-block"}'>修改</text>
					  	</view>
					  	<view :style='{"display":"flex"}' v-if="(userid && isAuth('tijianfenlei','删除')) || (!userid && isAuthFront('tijianfenlei','删除'))" @click.stop="onDeleteTap(list[5].id)">
					  		<text :style='{"margin":"0 8rpx 0 0","fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}' class="iconfont icon-shanchu1"></text>
					  		<text :style='{"fontSize":"28rpx","lineHeight":"1","color":"#cc0000","display":"inline-block"}'>删除</text>
					  	</view>
					  </view>
		...
		<button :style='{"border":"0","boxShadow":"0 2rpx 12rpx #cccccc","color":"#333333","bottom":"120rpx","right":"120rpx","outline":"none","borderRadius":"100%","background":"#75ebde","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"fixed","height":"80rpx","zIndex":"999"}' v-if="userid && isAuth('tijianfenlei','新增')" class="add-btn" @click="onAddTap()">新增</button>
		<button :style='{"border":"0","boxShadow":"0 2rpx 12rpx #cccccc","color":"#333333","bottom":"120rpx","right":"120rpx","outline":"none","borderRadius":"100%","background":"#75ebde","width":"80rpx","lineHeight":"80rpx","fontSize":"28rpx","position":"fixed","height":"80rpx","zIndex":"999"}' v-if="!userid && isAuthFront('tijianfenlei','新增')" class="add-btn" @click="onAddTap()">新增</button>
	</view>
</mescroll-uni>
</template>
	...
	export default {
		...
		methods: {
			...
			async upCallback(mescroll) {
				...
				if(this.searchForm.tijianfenlei){
					params['tijianfenlei'] = '%' + this.searchForm.tijianfenlei + '%'
				}
                ...
                let res = {}
                if(this.userid) {
                    res = await this.$api.page(`tijianfenlei`, params);
                } else {
                    res = await this.$api.list(`tijianfenlei`, params);
                }
				// 如果是第一页数据置空
			...
			onDeleteTap(id){
				...
				uni.showModal({
					...
					success: async function(res) {
						if (res.confirm) {
							await _this.$api.del('tijianfenlei', JSON.stringify([id]));
							_this.hasNext = true
							// 重置分页参数页数为1
			...
			async search(){
				...
				if(this.searchForm.tijianfenlei){
					searchForm['tijianfenlei'] = '%' + this.searchForm.tijianfenlei + '%'
				}
                let res = {};
                if(this.userid) {
                    res = await this.$api.page(`tijianfenlei`, searchForm);
                } else {
                    res = await this.$api.list(`tijianfenlei`, searchForm);
                }
				// 如果是第一页数据置空
